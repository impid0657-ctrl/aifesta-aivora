    ...
    >
      <div className="xb-footer-wrap">
        ...
        <div className="xb-footer-heading wow zoomIn" data-wow-duration="600ms">
          <h1 className="title">AI Festa</h1>

          <a className="mail" href="mailto:info@aifesta.kr">
        ...
        <div className="xb-footer-nav">
          {[
            { label: "행사 소개", title: "AI Festa 2026", href: "#" },
            { label: "주요 프로그램", title: "컨퍼런스", href: "#" },
            { label: "참가 안내", title: "전시 참가", href: "#" },
            { label: "비즈니스 매칭", title: "B2B 매칭", href: "#" },
            { label: "미디어", title: "보도자료", href: "#" },
          ].map((item, i) => (
        ...
        <div className="xb-footer-bottom">
          ...
          <div className="contact-item copyright-item">
            <p>
              Copyright © 2026{" "}
              <Link href="/">AI Festa</Link>, All rights reserved.
            </p>
          </div>

          <div className="contact-item">
            <a href="mailto:info@aifesta.kr">
              <Image src={callIcon} alt="email" />
            </a>
            <a className="contact-method" href="mailto:info@aifesta.kr">
              info@aifesta.kr
            </a>
          </div>
        </div>
